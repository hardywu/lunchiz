...
Admin.create email: 'admin@test.io', password: 'changeme', username: 'admin'
...
owner2 = Owner.create email: 'owner2@test.io', password: 'changeme',
                      username: 'owner2'
Owner.create email: 'owner3@test.io', password: 'changeme', username: 'owner3'
...
user1.reviews.create store: owner1.stores.first, rate: 2, comment: 'bad',
                     date: '2017-01-01'
user2.reviews.create store: owner1.stores.first, rate: 5, comment: 'good',
                     date: '2017-03-01'
user3.reviews.create store: owner1.stores.first, rate: 1, comment: 'bad',
                     date: '2017-05-01'
